...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $graphSection1 = DB::select('SELECT SUM(correct) as result, test_id FROM `test_answers` WHERE question_id in (1,2,3,4) AND user_id= 5 GROUP BY ( test_id)  DESC LIMIT 5 ');
        $graphSection2 =DB::select('SELECT SUM(correct) as result, test_id FROM `test_answers` WHERE question_id in (1,2,3,4) AND user_id= 5 GROUP BY ( test_id) DESC LIMIT 5 ');
        $graphSection3 = DB::select('SELECT SUM(correct) as result, test_id FROM `test_answers` WHERE question_id in (1,2,3,4) AND user_id= 5 GROUP BY ( test_id) DESC LIMIT 5');
        ...
        $tableSection12 = DB::select('SELECT SUM(correct) as result, test_id FROM `test_answers` WHERE question_id in (1,2,3,4) AND user_id= 5 GROUP BY ( test_id)  DESC LIMIT 5');

        $tableSection13 = DB::select('SELECT SUM(correct) as result, test_id FROM `test_answers` WHERE question_id in (1,2,3,4) AND user_id= 5 GROUP BY ( test_id) DESC LIMIT 5 ');

        $tableSection14 = DB::select('SELECT SUM(correct) as result, test_id FROM `test_answers` WHERE question_id in (1,2,3,4) AND user_id= 5 GROUP BY ( test_id)  DESC LIMIT 5 ');
