...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><strong>{{ __('User Self Registration') }}</strong> </div><br>

                    <div class="card-body" style="color:red">{{ __('Please note that required fields are indicated with an(*)') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus placeholder="Enter Full Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required placeholder="Enter E-Mail Address">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="checkbox" class="{{ $errors->has('dob') ? ' is-invalid' : '' }}" name="terms" required value="1" required>
                                Agree with the <a href="https//www.google.com">terms and conditions *</a>
