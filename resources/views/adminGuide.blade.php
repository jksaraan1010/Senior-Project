...
<div class="content">
   <div class="container-fluid">
      ...
      <a href= "/EmailAdminGuide" onclick="return true;" target="_blank" class="btn btn-default"><i class="fa fa-envelope"></i> Email</a>
      <br>
      <br>
            ...
            <div class="card h-100">
               ...
               <div class="card-body">
                  <p> Everytime you login you will land in this page.
                     ...
                     your browser once you've logged out of the application. 
                  <p>
               </div>
               <!-- /.card-body -->
            </div>
            ...
            <div class="card h-100">
               ...
               <div class="card-body">
                  <p> Similar to this page, the user guide 
                     will serve as a guide to the different pages in the application.  
                  </P>
               </div>
               <!-- /.card-body -->
            </div>
