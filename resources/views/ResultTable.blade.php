...
<html>
   ...
   <tbody>
   <tr>
   <!-- loop over each date taken and add in every into table-->
   ...
   <!-- loop over each score of self care and add in every into table-->
   <tr>
   ...
   <!-- loop over each score of health awareness and add in every into table-->
   <tr>
   ...
   <!-- loop over each score of communication and add in every into table-->
   <tr>
   ...
   <!-- loop over each score of each total score and add in every into table-->
   <tr>
